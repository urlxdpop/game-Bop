...
public class DBController : MonoBehaviour {
    ...
    private const string URL = "http://localhost:81/DBForGapGame/";
    ...
    IEnumerator CreatePlayerRequest(string name, string password, GameData levelData, SaveData.SecretsData secretsData, Action<bool, string> callback) {
    ...
    IEnumerator UpdateDataRequest(int id, GameData levelData, SaveData.SecretsData secretsData, System.Action<bool, string> callback) {
